 ...
 *
 */
public class BTreeInternalPage extends BTreePage implements Iterable<BTreeEntry> {
	...
	/**
	 * private method, should only be called by stream()
	 */
	@Deprecated
	private BTreePageId getChildNoException(int i) {
		try {
			return getChildId(i);
		} catch (NoSuchElementException e) {
			return null;
